...
Partial Class frmFindIA
    ...
    Protected Sub btnFind_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnFind.Click
        Try
            grdSearchResult.DataSource = ProcessFlowData.fnFindTasksAndStatusIA(Convert.ToInt32(Session("ModuleUserId")), txtDescription.Text, drpDocumentType.SelectedValue, drpApprover.SelectedValue, drpTaskStatus.SelectedValue, Convert.ToDateTime(txtDateFrom.Text), Convert.ToDateTime(txtDateTo.Text))
